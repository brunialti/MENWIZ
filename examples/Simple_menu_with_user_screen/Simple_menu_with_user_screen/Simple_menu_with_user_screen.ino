...
#define LAP_SPLASH  5000
#define LAP_USRSCREEN  7000
...
void setup(){
  ...
  sprintf(menu.sbuf,"MENWIZ TEST V %s#Free memory   : %d#Menu mem alloc: %d#Splash lap sec: %d",menu.getVer(),menu.freeRam(),mem-menu.freeRam(),LAP_SPLASH/1000);
  menu.addSplash((char *) menu.sbuf, LAP_SPLASH);
  ...
  menu.addUsrScreen(msc,LAP_USRSCREEN);
  }
...
// user defined default screen (Example)
void msc(){
  lcd.setCursor(0,0);
