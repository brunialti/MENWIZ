...
//          s2->setBehaviour(MW_SCROLL_HORIZONTAL,true); //...if you like horizontal scroll  
    ...
    s1=menu.addMenu(MW_VAR,r,"TEST ACTION");             //add a terminal node (that is "variable") create an "action" associated to the terminal node... 
    ...
    s1=menu.addMenu(MW_VAR,r,"SAVE TO EPROM");           //add a terminal node (that is "variable") create an "action" associated to the terminal node... 
      s1->addVar(MW_ACTION,savevar);                     //the act function as default will be called when enter button is pushed

    s1=menu.addMenu(MW_VAR,r,"LOAD FROM EEPROM");        //add a terminal node (that is "variable") create an "action" associated to the terminal node... 
